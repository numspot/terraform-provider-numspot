...
- Get your [Numspot credentials](https://console.cloudgouv-eu-west-1.numspot.com/fr/iam/service-accounts)
- Get your [Space ID](https://console.cloudgouv-eu-west-1.numspot.com/fr/iam/spaces)
...
```bash
$ export NUMSPOT_HOST="https://api.cloudgouv-eu-west-1.numspot.com"
...
variable "numspot_host" {
  type    = string
  default = "https://api.cloudgouv-eu-west-1.numspot.com"
}
...
|--------------------|-------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|
| `numspot_host`     | `NUMSPOT_HOST`                                  | [Numspot API host](https://api.cloudgouv-eu-west-1.numspot.com/)                                                                   |
