...
type CreateImageRequestSchema struct {
	...
	// SourceImageId The ID of the OMI you want to copy. You must specify only one of the following parameters: `FileLocation`, `RootDeviceName`, `SourceImageId` or `VmId`.
...
type CreateSnapshotRequestSchema struct {
	...
	// SourceSnapshotId (When copying) The ID of the snapshot you want to copy.
...
type ErrorResponseSchema struct {
	// S One or more errors.
	S *[]ErrorsSchema `json:"s,omitempty"`
}

// ErrorsSchema Information about the errors.
...
// LinkNicSchema Information about the NIC attachment.
type LinkNicSchema struct {
	// DeleteOnVmDeletion If true, the NIC is deleted when the VM is terminated.
	DeleteOnVmDeletion *bool `json:"deleteOnVmDeletion,omitempty"`
...
// LinkRouteTableSchema One or more associations between the route table and the Subnets.
type LinkRouteTableSchema struct {
	// Id The ID of the association between the route table and the Subnet.
	Id *string `json:"id,omitempty"`
...
type NicSchema struct {
	...
	LinkNic *LinkNicSchema `json:"linkNic,omitempty"`
...
type RouteTableSchema struct {
	...
	LinkRouteTables *[]LinkRouteTableSchema `json:"linkRouteTables,omitempty"`
...
type VirtualGatewaySchema struct {
	...
	NetToVirtualGatewayLinks *[]NetToVirtualGatewayLinkSchema `json:"netToVirtualGatewayLinks,omitempty"`
...
type VolumeSchema struct {
	...
	LinkedVolumes *[]LinkedVolumeSchema `json:"linkedVolumes,omitempty"`
...
type AcceptNetPeeringResponse struct {
	...
	JSON400      *ErrorResponseSchema
	JSON401      *ErrorResponseSchema
	JSON409      *ErrorResponseSchema
	JSON500      *ErrorResponseSchema
}
...
type DeleteLoadBalancerListenersResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *DeleteLoadBalancerListenersResponseSchema
}
...
type DeleteLoadBalancerPolicyResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *DeleteLoadBalancerPolicyResponseSchema
}
...
type DeleteRouteResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *DeleteRouteResponseSchema
	JSON400      *ErrorResponseSchema
	JSON401      *ErrorResponseSchema
	JSON500      *ErrorResponseSchema
}
...
type DeleteSecurityGroupRuleResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *DeleteSecurityGroupRuleResponseSchema
	JSON400      *ErrorResponseSchema
	JSON401      *ErrorResponseSchema
	JSON500      *ErrorResponseSchema
}
...
type DeleteVmsResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *DeleteVmsResponseSchema
	JSON400      *ErrorResponseSchema
	JSON401      *ErrorResponseSchema
	JSON500      *ErrorResponseSchema
}
