...
package datasource_server_certificate
...
func ServerCertificateDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"items": schema.ListNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"name": schema.StringAttribute{
							...
							MarkdownDescription: "The name of the server certificate.",
						},
						"path": schema.StringAttribute{
							Computed:            true,
							Description:         "The path to the server certificate.",
							MarkdownDescription: "The path to the server certificate.",
						},
				...
				MarkdownDescription: "Information about one or more Server certificates.",
			},
			"paths": schema.ListAttribute{
				...
				MarkdownDescription: "The paths to the server certificates.",
			},
		},
	}
}
...
func (t ItemsType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	uploadDateAttribute, ok := attributes["upload_date"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`upload_date is missing from object`)

		return nil, diags
	}

	uploadDateVal, ok := uploadDateAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`upload_date expected to be basetypes.StringValue, was: %T`, uploadDateAttribute))
	}
...
type ItemsValue struct {
	...
	UploadDate     basetypes.StringValue `tfsdk:"upload_date"`
...
func (v ItemsValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["upload_date"] = basetypes.StringType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.UploadDate.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["upload_date"] = val
...
func (v ItemsValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	attributeTypes := map[string]attr.Type{
		...
		"upload_date":     basetypes.StringType{},
	}
...
func (v ItemsValue) Equal(o attr.Value) bool {
	...
	if !v.UploadDate.Equal(other.UploadDate) {
		return false
	}
