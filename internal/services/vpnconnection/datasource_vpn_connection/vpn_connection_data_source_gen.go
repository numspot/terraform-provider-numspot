...
package datasource_vpn_connection
...
func (t ItemsType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	clientGatewayConfigurationAttribute, ok := attributes["client_gateway_configuration"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`client_gateway_configuration is missing from object`)

		return nil, diags
	}

	clientGatewayConfigurationVal, ok := clientGatewayConfigurationAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`client_gateway_configuration expected to be basetypes.StringValue, was: %T`, clientGatewayConfigurationAttribute))
	}

	clientGatewayIdAttribute, ok := attributes["client_gateway_id"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`client_gateway_id is missing from object`)

		return nil, diags
	}

	clientGatewayIdVal, ok := clientGatewayIdAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`client_gateway_id expected to be basetypes.StringValue, was: %T`, clientGatewayIdAttribute))
	}
	...
	staticRoutesOnlyAttribute, ok := attributes["static_routes_only"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`static_routes_only is missing from object`)

		return nil, diags
	}

	staticRoutesOnlyVal, ok := staticRoutesOnlyAttribute.(basetypes.BoolValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`static_routes_only expected to be basetypes.BoolValue, was: %T`, staticRoutesOnlyAttribute))
	}

	vgwTelemetriesAttribute, ok := attributes["vgw_telemetries"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`vgw_telemetries is missing from object`)

		return nil, diags
	}

	vgwTelemetriesVal, ok := vgwTelemetriesAttribute.(basetypes.ListValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`vgw_telemetries expected to be basetypes.ListValue, was: %T`, vgwTelemetriesAttribute))
	}
	...
	vpnOptionsAttribute, ok := attributes["vpn_options"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`vpn_options is missing from object`)

		return nil, diags
	}

	vpnOptionsVal, ok := vpnOptionsAttribute.(basetypes.ObjectValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`vpn_options expected to be basetypes.ObjectValue, was: %T`, vpnOptionsAttribute))
	}
	...
	return ItemsValue{
		ClientGatewayConfiguration: clientGatewayConfigurationVal,
		ClientGatewayId:            clientGatewayIdVal,
		ConnectionType:             connectionTypeVal,
		Id:                         idVal,
		Routes:                     routesVal,
		State:                      stateVal,
		StaticRoutesOnly:           staticRoutesOnlyVal,
		VgwTelemetries:             vgwTelemetriesVal,
		VirtualGatewayId:           virtualGatewayIdVal,
		VpnOptions:                 vpnOptionsVal,
...
type ItemsValue struct {
	ClientGatewayConfiguration basetypes.StringValue `tfsdk:"client_gateway_configuration"`
	ClientGatewayId            basetypes.StringValue `tfsdk:"client_gateway_id"`
	ConnectionType             basetypes.StringValue `tfsdk:"connection_type"`
	Id                         basetypes.StringValue `tfsdk:"id"`
	Routes                     basetypes.ListValue   `tfsdk:"routes"`
	State                      basetypes.StringValue `tfsdk:"state"`
	StaticRoutesOnly           basetypes.BoolValue   `tfsdk:"static_routes_only"`
	VgwTelemetries             basetypes.ListValue   `tfsdk:"vgw_telemetries"`
	VirtualGatewayId           basetypes.StringValue `tfsdk:"virtual_gateway_id"`
	VpnOptions                 basetypes.ObjectValue `tfsdk:"vpn_options"`
...
func (v ItemsValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["client_gateway_configuration"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["client_gateway_id"] = basetypes.StringType{}.TerraformType(ctx)
	...
	attrTypes["static_routes_only"] = basetypes.BoolType{}.TerraformType(ctx)
	attrTypes["vgw_telemetries"] = basetypes.ListType{
		ElemType: VgwTelemetriesValue{}.Type(ctx),
	}.TerraformType(ctx)
	attrTypes["virtual_gateway_id"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["vpn_options"] = basetypes.ObjectType{
		AttrTypes: VpnOptionsValue{}.AttributeTypes(ctx),
	}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.ClientGatewayConfiguration.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["client_gateway_configuration"] = val

		val, err = v.ClientGatewayId.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["client_gateway_id"] = val
		...
		val, err = v.StaticRoutesOnly.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["static_routes_only"] = val

		val, err = v.VgwTelemetries.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["vgw_telemetries"] = val
		...
		val, err = v.VpnOptions.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["vpn_options"] = val
...
func (v ItemsValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	vgwTelemetries := types.ListValueMust(
		VgwTelemetriesType{
			basetypes.ObjectType{
				AttrTypes: VgwTelemetriesValue{}.AttributeTypes(ctx),
			},
		},
		v.VgwTelemetries.Elements(),
	)

	if v.VgwTelemetries.IsNull() {
		vgwTelemetries = types.ListNull(
			VgwTelemetriesType{
				basetypes.ObjectType{
					AttrTypes: VgwTelemetriesValue{}.AttributeTypes(ctx),
				},
	...
	if v.VgwTelemetries.IsUnknown() {
		vgwTelemetries = types.ListUnknown(
			VgwTelemetriesType{
				basetypes.ObjectType{
					AttrTypes: VgwTelemetriesValue{}.AttributeTypes(ctx),
				},
	...
	var vpnOptions basetypes.ObjectValue

	if v.VpnOptions.IsNull() {
		vpnOptions = types.ObjectNull(
			VpnOptionsValue{}.AttributeTypes(ctx),
		)
	}

	if v.VpnOptions.IsUnknown() {
		vpnOptions = types.ObjectUnknown(
			VpnOptionsValue{}.AttributeTypes(ctx),
		)
	}

	if !v.VpnOptions.IsNull() && !v.VpnOptions.IsUnknown() {
		vpnOptions = types.ObjectValueMust(
			VpnOptionsValue{}.AttributeTypes(ctx),
			v.VpnOptions.Attributes(),
		)
	}

	attributeTypes := map[string]attr.Type{
		"client_gateway_configuration": basetypes.StringType{},
		"client_gateway_id":            basetypes.StringType{},
		...
		"static_routes_only": basetypes.BoolType{},
		"vgw_telemetries": basetypes.ListType{
			ElemType: VgwTelemetriesValue{}.Type(ctx),
		},
		"virtual_gateway_id": basetypes.StringType{},
		"vpn_options": basetypes.ObjectType{
			AttrTypes: VpnOptionsValue{}.AttributeTypes(ctx),
		},
	}
	...
	objVal, diags := types.ObjectValue(
		...
		map[string]attr.Value{
			"client_gateway_configuration": v.ClientGatewayConfiguration,
			"client_gateway_id":            v.ClientGatewayId,
			"connection_type":              v.ConnectionType,
			"id":                           v.Id,
			"routes":                       routes,
			"state":                        v.State,
			"static_routes_only":           v.StaticRoutesOnly,
...
func (v ItemsValue) Equal(o attr.Value) bool {
	...
	if !v.ClientGatewayConfiguration.Equal(other.ClientGatewayConfiguration) {
		return false
	}

	if !v.ClientGatewayId.Equal(other.ClientGatewayId) {
		return false
	}
	...
	if !v.StaticRoutesOnly.Equal(other.StaticRoutesOnly) {
		return false
	}

	if !v.VgwTelemetries.Equal(other.VgwTelemetries) {
		return false
	}
	...
	if !v.VpnOptions.Equal(other.VpnOptions) {
		return false
	}
...
func (v Phase1optionsValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	var ikeVersionsVal basetypes.ListValue
	switch {
	case v.IkeVersions.IsUnknown():
		ikeVersionsVal = types.ListUnknown(types.StringType)
	case v.IkeVersions.IsNull():
		ikeVersionsVal = types.ListNull(types.StringType)
	default:
	...
	var phase1dhGroupNumbersVal basetypes.ListValue
	switch {
	case v.Phase1dhGroupNumbers.IsUnknown():
		phase1dhGroupNumbersVal = types.ListUnknown(types.Int64Type)
	case v.Phase1dhGroupNumbers.IsNull():
		phase1dhGroupNumbersVal = types.ListNull(types.Int64Type)
	default:
		var d diag.Diagnostics
	...
	var phase1encryptionAlgorithmsVal basetypes.ListValue
	switch {
	case v.Phase1encryptionAlgorithms.IsUnknown():
		phase1encryptionAlgorithmsVal = types.ListUnknown(types.StringType)
	case v.Phase1encryptionAlgorithms.IsNull():
		phase1encryptionAlgorithmsVal = types.ListNull(types.StringType)
	default:
		var d diag.Diagnostics
	...
	var phase1integrityAlgorithmsVal basetypes.ListValue
	switch {
	case v.Phase1integrityAlgorithms.IsUnknown():
		phase1integrityAlgorithmsVal = types.ListUnknown(types.StringType)
	case v.Phase1integrityAlgorithms.IsNull():
		phase1integrityAlgorithmsVal = types.ListNull(types.StringType)
	default:
		var d diag.Diagnostics
...
func (v Phase2optionsValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	var phase2dhGroupNumbersVal basetypes.ListValue
	switch {
	case v.Phase2dhGroupNumbers.IsUnknown():
		phase2dhGroupNumbersVal = types.ListUnknown(types.Int64Type)
	case v.Phase2dhGroupNumbers.IsNull():
		phase2dhGroupNumbersVal = types.ListNull(types.Int64Type)
	default:
		var d diag.Diagnostics
	...
	var phase2encryptionAlgorithmsVal basetypes.ListValue
	switch {
	case v.Phase2encryptionAlgorithms.IsUnknown():
		phase2encryptionAlgorithmsVal = types.ListUnknown(types.StringType)
	case v.Phase2encryptionAlgorithms.IsNull():
		phase2encryptionAlgorithmsVal = types.ListNull(types.StringType)
	default:
		var d diag.Diagnostics
	...
	var phase2integrityAlgorithmsVal basetypes.ListValue
	switch {
	case v.Phase2integrityAlgorithms.IsUnknown():
		phase2integrityAlgorithmsVal = types.ListUnknown(types.StringType)
	case v.Phase2integrityAlgorithms.IsNull():
		phase2integrityAlgorithmsVal = types.ListNull(types.StringType)
	default:
		var d diag.Diagnostics
