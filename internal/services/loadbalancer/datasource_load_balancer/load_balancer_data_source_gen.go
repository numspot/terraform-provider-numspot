...
package datasource_load_balancer
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"tags": schema.ListNestedAttribute{
							...
							MarkdownDescription: "One or more tags associated with the load balancer.",
						},
...
func (t ItemsType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	applicationStickyCookiePoliciesAttribute, ok := attributes["application_sticky_cookie_policies"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`application_sticky_cookie_policies is missing from object`)

		return nil, diags
	}

	applicationStickyCookiePoliciesVal, ok := applicationStickyCookiePoliciesAttribute.(basetypes.ListValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`application_sticky_cookie_policies expected to be basetypes.ListValue, was: %T`, applicationStickyCookiePoliciesAttribute))
	}

	availabilityZoneNamesAttribute, ok := attributes["availability_zone_names"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`availability_zone_names is missing from object`)

		return nil, diags
	}

	availabilityZoneNamesVal, ok := availabilityZoneNamesAttribute.(basetypes.ListValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`availability_zone_names expected to be basetypes.ListValue, was: %T`, availabilityZoneNamesAttribute))
	}

	backendIpsAttribute, ok := attributes["backend_ips"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`backend_ips is missing from object`)

		return nil, diags
	}

	backendIpsVal, ok := backendIpsAttribute.(basetypes.ListValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`backend_ips expected to be basetypes.ListValue, was: %T`, backendIpsAttribute))
	}

	backendVmIdsAttribute, ok := attributes["backend_vm_ids"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`backend_vm_ids is missing from object`)

		return nil, diags
	}

	backendVmIdsVal, ok := backendVmIdsAttribute.(basetypes.ListValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`backend_vm_ids expected to be basetypes.ListValue, was: %T`, backendVmIdsAttribute))
	}

	dnsNameAttribute, ok := attributes["dns_name"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`dns_name is missing from object`)

		return nil, diags
	}

	dnsNameVal, ok := dnsNameAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`dns_name expected to be basetypes.StringValue, was: %T`, dnsNameAttribute))
	}
	...
	listenersAttribute, ok := attributes["listeners"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`listeners is missing from object`)

		return nil, diags
	}

	listenersVal, ok := listenersAttribute.(basetypes.ListValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`listeners expected to be basetypes.ListValue, was: %T`, listenersAttribute))
	}
	...
	securedCookiesAttribute, ok := attributes["secured_cookies"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`secured_cookies is missing from object`)

		return nil, diags
	}

	securedCookiesVal, ok := securedCookiesAttribute.(basetypes.BoolValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`secured_cookies expected to be basetypes.BoolValue, was: %T`, securedCookiesAttribute))
	}
	...
	stickyCookiePoliciesAttribute, ok := attributes["sticky_cookie_policies"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`sticky_cookie_policies is missing from object`)

		return nil, diags
	}

	stickyCookiePoliciesVal, ok := stickyCookiePoliciesAttribute.(basetypes.ListValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`sticky_cookie_policies expected to be basetypes.ListValue, was: %T`, stickyCookiePoliciesAttribute))
	}
	...
	return ItemsValue{
		ApplicationStickyCookiePolicies: applicationStickyCookiePoliciesVal,
		AvailabilityZoneNames:           availabilityZoneNamesVal,
		BackendIps:                      backendIpsVal,
		BackendVmIds:                    backendVmIdsVal,
		DnsName:                         dnsNameVal,
		HealthCheck:                     healthCheckVal,
		Listeners:                       listenersVal,
		Name:                            nameVal,
		PublicIp:                        publicIpVal,
		SecuredCookies:                  securedCookiesVal,
		SecurityGroups:                  securityGroupsVal,
		StickyCookiePolicies:            stickyCookiePoliciesVal,
		Subnets:                         subnetsVal,
		Tags:                            tagsVal,
		ItemsType:                       typeVal,
		VpcId:                           vpcIdVal,
...
type ItemsValue struct {
	ApplicationStickyCookiePolicies basetypes.ListValue   `tfsdk:"application_sticky_cookie_policies"`
	AvailabilityZoneNames           basetypes.ListValue   `tfsdk:"availability_zone_names"`
	BackendIps                      basetypes.ListValue   `tfsdk:"backend_ips"`
	BackendVmIds                    basetypes.ListValue   `tfsdk:"backend_vm_ids"`
	DnsName                         basetypes.StringValue `tfsdk:"dns_name"`
	HealthCheck                     basetypes.ObjectValue `tfsdk:"health_check"`
	Listeners                       basetypes.ListValue   `tfsdk:"listeners"`
	Name                            basetypes.StringValue `tfsdk:"name"`
	PublicIp                        basetypes.StringValue `tfsdk:"public_ip"`
	SecuredCookies                  basetypes.BoolValue   `tfsdk:"secured_cookies"`
	SecurityGroups                  basetypes.ListValue   `tfsdk:"security_groups"`
	StickyCookiePolicies            basetypes.ListValue   `tfsdk:"sticky_cookie_policies"`
...
func (v ItemsValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["application_sticky_cookie_policies"] = basetypes.ListType{
		ElemType: ApplicationStickyCookiePoliciesValue{}.Type(ctx),
	}.TerraformType(ctx)
	attrTypes["availability_zone_names"] = basetypes.ListType{
		ElemType: types.StringType,
	}.TerraformType(ctx)
	attrTypes["backend_ips"] = basetypes.ListType{
		ElemType: types.StringType,
	}.TerraformType(ctx)
	attrTypes["backend_vm_ids"] = basetypes.ListType{
		ElemType: types.StringType,
	}.TerraformType(ctx)
	attrTypes["dns_name"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["health_check"] = basetypes.ObjectType{
		AttrTypes: HealthCheckValue{}.AttributeTypes(ctx),
	}.TerraformType(ctx)
	attrTypes["listeners"] = basetypes.ListType{
		ElemType: ListenersValue{}.Type(ctx),
	}.TerraformType(ctx)
	attrTypes["name"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["public_ip"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["secured_cookies"] = basetypes.BoolType{}.TerraformType(ctx)
	attrTypes["security_groups"] = basetypes.ListType{
		ElemType: types.StringType,
	}.TerraformType(ctx)
	attrTypes["sticky_cookie_policies"] = basetypes.ListType{
		ElemType: StickyCookiePoliciesValue{}.Type(ctx),
	}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.ApplicationStickyCookiePolicies.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["application_sticky_cookie_policies"] = val

		val, err = v.AvailabilityZoneNames.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["availability_zone_names"] = val

		val, err = v.BackendIps.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["backend_ips"] = val

		val, err = v.BackendVmIds.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["backend_vm_ids"] = val

		val, err = v.DnsName.ToTerraformValue(ctx)
		...
		val, err = v.Listeners.ToTerraformValue(ctx)
		...
		val, err = v.SecuredCookies.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["secured_cookies"] = val
		...
		val, err = v.StickyCookiePolicies.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["sticky_cookie_policies"] = val
...
func (v ItemsValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	applicationStickyCookiePolicies := types.ListValueMust(
		ApplicationStickyCookiePoliciesType{
			basetypes.ObjectType{
				AttrTypes: ApplicationStickyCookiePoliciesValue{}.AttributeTypes(ctx),
			},
		},
		v.ApplicationStickyCookiePolicies.Elements(),
	)

	if v.ApplicationStickyCookiePolicies.IsNull() {
		applicationStickyCookiePolicies = types.ListNull(
			ApplicationStickyCookiePoliciesType{
				basetypes.ObjectType{
					AttrTypes: ApplicationStickyCookiePoliciesValue{}.AttributeTypes(ctx),
				},
	...
	if v.ApplicationStickyCookiePolicies.IsUnknown() {
		applicationStickyCookiePolicies = types.ListUnknown(
			ApplicationStickyCookiePoliciesType{
				basetypes.ObjectType{
					AttrTypes: ApplicationStickyCookiePoliciesValue{}.AttributeTypes(ctx),
				},
	...
	listeners := types.ListValueMust(
		...
		v.Listeners.Elements(),
	)

	if v.Listeners.IsNull() {
		listeners = types.ListNull(
			ListenersType{
				basetypes.ObjectType{
					AttrTypes: ListenersValue{}.AttributeTypes(ctx),
				},
	...
	if v.Listeners.IsUnknown() {
		listeners = types.ListUnknown(
			ListenersType{
				basetypes.ObjectType{
					AttrTypes: ListenersValue{}.AttributeTypes(ctx),
				},
	...
	stickyCookiePolicies := types.ListValueMust(
		StickyCookiePoliciesType{
			basetypes.ObjectType{
				AttrTypes: StickyCookiePoliciesValue{}.AttributeTypes(ctx),
			},
		},
		v.StickyCookiePolicies.Elements(),
	)

	if v.StickyCookiePolicies.IsNull() {
		stickyCookiePolicies = types.ListNull(
			StickyCookiePoliciesType{
				basetypes.ObjectType{
					AttrTypes: StickyCookiePoliciesValue{}.AttributeTypes(ctx),
				},
	...
	if v.StickyCookiePolicies.IsUnknown() {
		stickyCookiePolicies = types.ListUnknown(
			StickyCookiePoliciesType{
				basetypes.ObjectType{
					AttrTypes: StickyCookiePoliciesValue{}.AttributeTypes(ctx),
				},
	...
	var availabilityZoneNamesVal basetypes.ListValue
	switch {
	case v.AvailabilityZoneNames.IsUnknown():
		availabilityZoneNamesVal = types.ListUnknown(types.StringType)
	case v.AvailabilityZoneNames.IsNull():
		availabilityZoneNamesVal = types.ListNull(types.StringType)
	default:
		var d diag.Diagnostics
		availabilityZoneNamesVal, d = types.ListValue(types.StringType, v.AvailabilityZoneNames.Elements())
		diags.Append(d...)
	}

	if diags.HasError() {
		return types.ObjectUnknown(map[string]attr.Type{
			"application_sticky_cookie_policies": basetypes.ListType{
				ElemType: ApplicationStickyCookiePoliciesValue{}.Type(ctx),
			},
			"availability_zone_names": basetypes.ListType{
				ElemType: types.StringType,
			},
			"backend_ips": basetypes.ListType{
				ElemType: types.StringType,
			},
			"backend_vm_ids": basetypes.ListType{
				ElemType: types.StringType,
			},
			"dns_name": basetypes.StringType{},
			"health_check": basetypes.ObjectType{
				AttrTypes: HealthCheckValue{}.AttributeTypes(ctx),
			},
			"listeners": basetypes.ListType{
				ElemType: ListenersValue{}.Type(ctx),
			},
			"name":            basetypes.StringType{},
			"public_ip":       basetypes.StringType{},
			"secured_cookies": basetypes.BoolType{},
			"security_groups": basetypes.ListType{
				ElemType: types.StringType,
			},
			"sticky_cookie_policies": basetypes.ListType{
				ElemType: StickyCookiePoliciesValue{}.Type(ctx),
			},
	...
	var backendIpsVal basetypes.ListValue
	switch {
	case v.BackendIps.IsUnknown():
		backendIpsVal = types.ListUnknown(types.StringType)
	case v.BackendIps.IsNull():
		backendIpsVal = types.ListNull(types.StringType)
	default:
		var d diag.Diagnostics
		backendIpsVal, d = types.ListValue(types.StringType, v.BackendIps.Elements())
		diags.Append(d...)
	}
	...
	var backendVmIdsVal basetypes.ListValue
	switch {
	case v.BackendVmIds.IsUnknown():
		backendVmIdsVal = types.ListUnknown(types.StringType)
	case v.BackendVmIds.IsNull():
		backendVmIdsVal = types.ListNull(types.StringType)
	default:
		var d diag.Diagnostics
		backendVmIdsVal, d = types.ListValue(types.StringType, v.BackendVmIds.Elements())
		diags.Append(d...)
	}
	...
	objVal, diags := types.ObjectValue(
		...
		map[string]attr.Value{
			"application_sticky_cookie_policies": applicationStickyCookiePolicies,
			"availability_zone_names":            availabilityZoneNamesVal,
			"backend_ips":                        backendIpsVal,
			"backend_vm_ids":                     backendVmIdsVal,
			"dns_name":                           v.DnsName,
			"health_check":                       healthCheck,
			"listeners":                          listeners,
			"name":                               v.Name,
			"public_ip":                          v.PublicIp,
			"secured_cookies":                    v.SecuredCookies,
			"security_groups":                    securityGroupsVal,
			"sticky_cookie_policies":             stickyCookiePolicies,
			"subnets":                            subnetsVal,
			"tags":                               tags,
			"type":                               v.ItemsType,
			"vpc_id":                             v.VpcId,
...
func (v ItemsValue) Equal(o attr.Value) bool {
	...
	if !v.ApplicationStickyCookiePolicies.Equal(other.ApplicationStickyCookiePolicies) {
		return false
	}

	if !v.AvailabilityZoneNames.Equal(other.AvailabilityZoneNames) {
		return false
	}

	if !v.BackendIps.Equal(other.BackendIps) {
		return false
	}

	if !v.BackendVmIds.Equal(other.BackendVmIds) {
		return false
	}

	if !v.DnsName.Equal(other.DnsName) {
		return false
	}
	...
	if !v.Listeners.Equal(other.Listeners) {
		return false
	}
	...
	if !v.SecuredCookies.Equal(other.SecuredCookies) {
		return false
	}
	...
	if !v.StickyCookiePolicies.Equal(other.StickyCookiePolicies) {
		return false
	}
...
func (v ListenersValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	var policyNamesVal basetypes.ListValue
	switch {
	case v.PolicyNames.IsUnknown():
		policyNamesVal = types.ListUnknown(types.StringType)
	case v.PolicyNames.IsNull():
		policyNamesVal = types.ListNull(types.StringType)
	default:
		var d diag.Diagnostics
