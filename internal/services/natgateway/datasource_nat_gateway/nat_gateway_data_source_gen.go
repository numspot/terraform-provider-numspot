...
package datasource_nat_gateway
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"tags": schema.ListNestedAttribute{
							...
							MarkdownDescription: "One or more tags associated with the NAT gateway.",
						},
...
func (t ItemsType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	publicIpsAttribute, ok := attributes["public_ips"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`public_ips is missing from object`)

		return nil, diags
	}

	publicIpsVal, ok := publicIpsAttribute.(basetypes.ListValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`public_ips expected to be basetypes.ListValue, was: %T`, publicIpsAttribute))
	}
...
type ItemsValue struct {
	...
	PublicIps basetypes.ListValue   `tfsdk:"public_ips"`
...
func (v ItemsValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["public_ips"] = basetypes.ListType{
		ElemType: PublicIpsValue{}.Type(ctx),
	}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.PublicIps.ToTerraformValue(ctx)
...
func (v ItemsValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	publicIps := types.ListValueMust(
		PublicIpsType{
			basetypes.ObjectType{
				AttrTypes: PublicIpsValue{}.AttributeTypes(ctx),
			},
		},
		v.PublicIps.Elements(),
	)

	if v.PublicIps.IsNull() {
		publicIps = types.ListNull(
			PublicIpsType{
				basetypes.ObjectType{
					AttrTypes: PublicIpsValue{}.AttributeTypes(ctx),
				},
	...
	if v.PublicIps.IsUnknown() {
		publicIps = types.ListUnknown(
			PublicIpsType{
				basetypes.ObjectType{
					AttrTypes: PublicIpsValue{}.AttributeTypes(ctx),
				},
...
func (v ItemsValue) Equal(o attr.Value) bool {
	...
	if !v.PublicIps.Equal(other.PublicIps) {
		return false
	}
