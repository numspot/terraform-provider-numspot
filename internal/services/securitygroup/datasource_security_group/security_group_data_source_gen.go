...
package datasource_security_group
...
func (t ItemsType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	inboundRulesAttribute, ok := attributes["inbound_rules"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`inbound_rules is missing from object`)

		return nil, diags
	}

	inboundRulesVal, ok := inboundRulesAttribute.(basetypes.ListValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`inbound_rules expected to be basetypes.ListValue, was: %T`, inboundRulesAttribute))
	}
	...
	outboundRulesAttribute, ok := attributes["outbound_rules"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`outbound_rules is missing from object`)

		return nil, diags
	}

	outboundRulesVal, ok := outboundRulesAttribute.(basetypes.ListValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`outbound_rules expected to be basetypes.ListValue, was: %T`, outboundRulesAttribute))
	}
	...
	return ItemsValue{
		...
		Id:            idVal,
		InboundRules:  inboundRulesVal,
		Name:          nameVal,
		OutboundRules: outboundRulesVal,
		Tags:          tagsVal,
		VpcId:         vpcIdVal,
...
type ItemsValue struct {
	...
	InboundRules  basetypes.ListValue   `tfsdk:"inbound_rules"`
	Name          basetypes.StringValue `tfsdk:"name"`
	OutboundRules basetypes.ListValue   `tfsdk:"outbound_rules"`
...
func (v ItemsValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["inbound_rules"] = basetypes.ListType{
		ElemType: InboundRulesValue{}.Type(ctx),
	}.TerraformType(ctx)
	attrTypes["name"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["outbound_rules"] = basetypes.ListType{
		ElemType: OutboundRulesValue{}.Type(ctx),
	}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.InboundRules.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["inbound_rules"] = val
		...
		val, err = v.OutboundRules.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["outbound_rules"] = val
...
func (v ItemsValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	inboundRules := types.ListValueMust(
		InboundRulesType{
			basetypes.ObjectType{
				AttrTypes: InboundRulesValue{}.AttributeTypes(ctx),
			},
		},
		v.InboundRules.Elements(),
	)

	if v.InboundRules.IsNull() {
		inboundRules = types.ListNull(
			InboundRulesType{
				basetypes.ObjectType{
					AttrTypes: InboundRulesValue{}.AttributeTypes(ctx),
				},
	...
	if v.InboundRules.IsUnknown() {
		inboundRules = types.ListUnknown(
			InboundRulesType{
				basetypes.ObjectType{
					AttrTypes: InboundRulesValue{}.AttributeTypes(ctx),
				},
	...
	outboundRules := types.ListValueMust(
		OutboundRulesType{
			basetypes.ObjectType{
				AttrTypes: OutboundRulesValue{}.AttributeTypes(ctx),
			},
		},
		v.OutboundRules.Elements(),
	)

	if v.OutboundRules.IsNull() {
		outboundRules = types.ListNull(
			OutboundRulesType{
				basetypes.ObjectType{
					AttrTypes: OutboundRulesValue{}.AttributeTypes(ctx),
				},
	...
	if v.OutboundRules.IsUnknown() {
		outboundRules = types.ListUnknown(
			OutboundRulesType{
				basetypes.ObjectType{
					AttrTypes: OutboundRulesValue{}.AttributeTypes(ctx),
				},
	...
	attributeTypes := map[string]attr.Type{
		...
		"inbound_rules": basetypes.ListType{
			ElemType: InboundRulesValue{}.Type(ctx),
		},
		"name": basetypes.StringType{},
		"outbound_rules": basetypes.ListType{
			ElemType: OutboundRulesValue{}.Type(ctx),
		},
...
func (v ItemsValue) Equal(o attr.Value) bool {
	...
	if !v.InboundRules.Equal(other.InboundRules) {
		return false
	}
	...
	if !v.OutboundRules.Equal(other.OutboundRules) {
		return false
	}
