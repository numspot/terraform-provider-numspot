...
package datasource_compute_bridge
...
func ComputeBridgeDataSourceSchema(ctx context.Context) schema.Schema {
...
func (t ItemsType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	sourceIpRangeAttribute, ok := attributes["source_ip_range"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`source_ip_range is missing from object`)

		return nil, diags
	}

	sourceIpRangeVal, ok := sourceIpRangeAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`source_ip_range expected to be basetypes.StringValue, was: %T`, sourceIpRangeAttribute))
	}
	...
	return ItemsValue{
		...
		Id:                 idVal,
		SourceIpRange:      sourceIpRangeVal,
...
type ItemsValue struct {
	...
	SourceIpRange      basetypes.StringValue `tfsdk:"source_ip_range"`
...
func (v ItemsValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["source_ip_range"] = basetypes.StringType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.SourceIpRange.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["source_ip_range"] = val
...
func (v ItemsValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	attributeTypes := map[string]attr.Type{
		...
		"source_ip_range":      basetypes.StringType{},
	}
	...
	objVal, diags := types.ObjectValue(
		...
		map[string]attr.Value{
			...
			"id":                   v.Id,
			"source_ip_range":      v.SourceIpRange,
		})
...
func (v ItemsValue) Equal(o attr.Value) bool {
	...
	if !v.SourceIpRange.Equal(other.SourceIpRange) {
		return false
	}
