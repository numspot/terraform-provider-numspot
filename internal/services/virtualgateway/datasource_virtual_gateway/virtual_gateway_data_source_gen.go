...
func (t ItemsType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	vpcToVirtualGatewayLinksAttribute, ok := attributes["vpc_to_virtual_gateway_links"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`vpc_to_virtual_gateway_links is missing from object`)

		return nil, diags
	}

	vpcToVirtualGatewayLinksVal, ok := vpcToVirtualGatewayLinksAttribute.(basetypes.ListValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`vpc_to_virtual_gateway_links expected to be basetypes.ListValue, was: %T`, vpcToVirtualGatewayLinksAttribute))
	}
	...
	return ItemsValue{
		...
		Id:                       idVal,
		State:                    stateVal,
		VpcToVirtualGatewayLinks: vpcToVirtualGatewayLinksVal,
...
type ItemsValue struct {
	...
	VpcToVirtualGatewayLinks basetypes.ListValue   `tfsdk:"vpc_to_virtual_gateway_links"`
...
func (v ItemsValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["vpc_to_virtual_gateway_links"] = basetypes.ListType{
		ElemType: VpcToVirtualGatewayLinksValue{}.Type(ctx),
	}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.VpcToVirtualGatewayLinks.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["vpc_to_virtual_gateway_links"] = val
...
func (v ItemsValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	vpcToVirtualGatewayLinks := types.ListValueMust(
		VpcToVirtualGatewayLinksType{
			basetypes.ObjectType{
				AttrTypes: VpcToVirtualGatewayLinksValue{}.AttributeTypes(ctx),
			},
		},
		v.VpcToVirtualGatewayLinks.Elements(),
	)

	if v.VpcToVirtualGatewayLinks.IsNull() {
		vpcToVirtualGatewayLinks = types.ListNull(
			VpcToVirtualGatewayLinksType{
				basetypes.ObjectType{
					AttrTypes: VpcToVirtualGatewayLinksValue{}.AttributeTypes(ctx),
				},
	...
	if v.VpcToVirtualGatewayLinks.IsUnknown() {
		vpcToVirtualGatewayLinks = types.ListUnknown(
			VpcToVirtualGatewayLinksType{
				basetypes.ObjectType{
					AttrTypes: VpcToVirtualGatewayLinksValue{}.AttributeTypes(ctx),
				},
	...
	attributeTypes := map[string]attr.Type{
		...
		"vpc_to_virtual_gateway_links": basetypes.ListType{
			ElemType: VpcToVirtualGatewayLinksValue{}.Type(ctx),
		},
	}
	...
	objVal, diags := types.ObjectValue(
		...
		map[string]attr.Value{
			...
			"id":                           v.Id,
			"state":                        v.State,
			"vpc_to_virtual_gateway_links": vpcToVirtualGatewayLinks,
		})
...
func (v ItemsValue) Equal(o attr.Value) bool {
	...
	if !v.VpcToVirtualGatewayLinks.Equal(other.VpcToVirtualGatewayLinks) {
		return false
	}
