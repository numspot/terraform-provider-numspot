...
func TestAccDhcpOptionsResource(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{ // Create testing
				Config: testDhcpOptionsConfig(utils_acctest.BASE_SUFFIX, basePlanValues),
				Check: resource.ComposeAggregateTestCheckFunc(slices.Concat(
					createChecks,
					getDependencyChecksDhcpOptions(utils_acctest.BASE_SUFFIX),
				)...),
			},
			// ImportState testing
			{
			...
			{
				Config: testDhcpOptionsConfig(utils_acctest.BASE_SUFFIX, updatePlanValues),
				Check: resource.ComposeAggregateTestCheckFunc(slices.Concat(
					updateChecks,
					getDependencyChecksDhcpOptions(utils_acctest.BASE_SUFFIX),
				)...),
			...
			{
				Config: testDhcpOptionsConfig(utils_acctest.BASE_SUFFIX, replacePlanValues),
				Check: resource.ComposeAggregateTestCheckFunc(slices.Concat(
					replaceChecks,
					getDependencyChecksDhcpOptions(utils_acctest.BASE_SUFFIX),
				)...),
			...
			{
				Config: testDhcpOptionsConfig(utils_acctest.NEW_SUFFIX, updatePlanValues),
				Check: resource.ComposeAggregateTestCheckFunc(slices.Concat(
					updateChecks,
					getDependencyChecksDhcpOptions(utils_acctest.NEW_SUFFIX),
				)...),
			},
			...
			{
				Config: testDhcpOptionsConfig(utils_acctest.NEW_SUFFIX, replacePlanValues),
				Check: resource.ComposeAggregateTestCheckFunc(slices.Concat(
					replaceChecks,
					getDependencyChecksDhcpOptions(utils_acctest.NEW_SUFFIX),
				)...),
