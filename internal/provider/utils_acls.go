...
func CreateAclListFromTf(ctx context.Context, tf resource_acls.ACLsModel) ([]numspot.ACL, diag.Diagnostics) {
...
func CreateTfAclFromHttp(ctx context.Context, http numspot.ACL) (resource_acls.ACLValue, diag.Diagnostics) {
